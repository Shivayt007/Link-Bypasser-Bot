...
# bot
bot_token = os.environ.get("TOKEN", "5614960058:AAEwWI-eqXD9bXKfJG1853jUEzFCHb44Bx0")
api_hash = os.environ.get("HASH", "4227c1e45e462209a3dcc67ada88a44f") 
api_id = os.environ.get("ID", "2054877")
...
def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    app.send_message(message.chat.id, f"__👋 Hi **{message.from_user.mention}**, i am Link Bypasser Bot , just send me any supported links .My Admin Only Ride Me ",
    reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("🌐 Source Code", url="https://google.com")]]), reply_to_message_id=message.id)
